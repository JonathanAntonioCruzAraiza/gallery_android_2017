...
public class GalleryBateriaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.main_fragment_bateria,container,false) ;
    ...
    public void onStart() {
        ...
        vpGallery=(ViewPager)getView().findViewById(R.id.vp_gallery_bateria);
    ...
    public static class FragmentImage extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
                                 @Nullable ViewGroup container,
                                 @Nullable Bundle savedInstanceState) {
           View rootView = inflater.inflate(R.layout.gallery_layout_bateria,container,false);
            ImageView ivPhoto = (ImageView) rootView.findViewById(R.id.iv_photo_bateria);
